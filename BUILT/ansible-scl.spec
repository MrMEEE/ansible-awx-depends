...
Name: %{?scl_prefix}ansible
Version: %{version}
Release: %{release}
Source0: ansible-%{unmangled_version}.tar.gz
License: GPLv3+
Group: Development/Libraries
BuildRoot: %{_tmppath}/ansible-%{version}-%{release}-buildroot
Prefix: %{_prefix}
BuildArch: noarch
Vendor: Ansible, Inc. <info@ansible.com>
...
set -ex
%setup -n ansible-%{unmangled_version} -n ansible-%{unmangled_version}
%{?scl:EOF}
