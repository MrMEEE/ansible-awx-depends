...
Name: %{?scl_prefix}azure-mgmt-nspkg
Version: %{version}
Release: %{release}
Source0: azure-mgmt-nspkg-%{unmangled_version}.zip
License: MIT License
Group: Development/Libraries
BuildRoot: %{_tmppath}/azure-mgmt-nspkg-%{version}-%{release}-buildroot
Prefix: %{_prefix}
BuildArch: noarch
...
set -ex
%setup -n azure-mgmt-nspkg-%{unmangled_version} -n azure-mgmt-nspkg-%{unmangled_version}
%{?scl:EOF}
