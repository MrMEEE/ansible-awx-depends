...
%define unmangled_version 4.4.3
%define unmangled_version 4.4.3
%define release 1
...
Version: %{version}
Release: %{release}
Source0: zope.interface-%{unmangled_version}.tar.gz
License: ZPL 2.1
...
set -ex
%setup -n zope.interface-%{unmangled_version} -n zope.interface-%{unmangled_version}
%{?scl:EOF}
