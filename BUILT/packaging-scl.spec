...
Name: %{?scl_prefix}packaging
Version: %{version}
Release: %{release}
Source0: packaging-%{unmangled_version}.tar.gz
License: BSD or Apache License, Version 2.0
Group: Development/Libraries
BuildRoot: %{_tmppath}/packaging-%{version}-%{release}-buildroot
Prefix: %{_prefix}
BuildArch: noarch
...
set -ex
%setup -n packaging-%{unmangled_version} -n packaging-%{unmangled_version}
%{?scl:EOF}
