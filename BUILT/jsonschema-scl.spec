...
Version: %{version}
Release: %{release}
Source0: jsonschema-%{unmangled_version}.tar.gz
License: MIT
Group: Development/Libraries
BuildRoot: %{_tmppath}/%{pkg_name}-%{version}-%{release}-buildroot
Prefix: %{_prefix}
BuildArch: noarch
Vendor: Julian Berman <Julian@GrayVines.com>
Packager: Martin Juhl <m@rtinjuhl.dk>
Url: http://github.com/Julian/jsonschema
BuildRequires: %{?scl_prefix}vcversioner
...
set -ex
%setup -n jsonschema-%{unmangled_version} -n jsonschema-%{unmangled_version}
%{?scl:EOF}
