...
%define name colorama
%define version 0.3.9
%define unmangled_version 0.3.9
%define unmangled_version 0.3.9
%define release 1
...
Name: %{?scl_prefix}colorama
Version: %{version}
Release: %{release}
Source0: colorama-%{unmangled_version}.tar.gz
License: BSD
Group: Development/Libraries
BuildRoot: %{_tmppath}/colorama-%{version}-%{release}-buildroot
Prefix: %{_prefix}
BuildArch: noarch
Vendor: Arnon Yaari <tartley@tartley.com>
...
set -ex
%setup -n colorama-%{unmangled_version} -n colorama-%{unmangled_version}
%{?scl:EOF}
