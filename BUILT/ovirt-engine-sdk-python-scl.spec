...
%define name ovirt-engine-sdk-python
%define version 4.2.4
%define unmangled_version 4.2.4
%define unmangled_version 4.2.4
%define release 1
...
Name: %{?scl_prefix}ovirt-engine-sdk-python
Version: %{version}
Release: %{release}
Source0: ovirt-engine-sdk-python-%{unmangled_version}.tar.gz
License: ASL2
Group: Development/Libraries
BuildRoot: %{_tmppath}/ovirt-engine-sdk-python-%{version}-%{release}-buildroot
Prefix: %{_prefix}
Vendor: Michael Pasternak, Juan Hernandez, Ondra Machacek <mishka8520@yahoo.com, juan.hernandez@redhat.com, omachace@redhat.com>
...
set -ex
%setup -n ovirt-engine-sdk-python-%{unmangled_version} -n ovirt-engine-sdk-python-%{unmangled_version}
%{?scl:EOF}
