...
Version: %{version}
Release: %{release}
Source0: more-itertools-%{unmangled_version}.tar.gz
License: MIT
Group: Development/Libraries
BuildRoot: %{_tmppath}/%{pkg_name}-%{version}-%{release}-buildroot
Prefix: %{_prefix}
BuildArch: noarch
Vendor: Erik Rose <erikrose@grinchcentral.com>
...
set -ex
%setup -n more-itertools-%{unmangled_version} -n more-itertools-%{unmangled_version}
%{?scl:EOF}
