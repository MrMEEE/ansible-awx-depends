...
%define name applicationinsights
%define version 0.11.1
%define unmangled_version 0.11.1
%define unmangled_version 0.11.1
%define release 1
...
Name: %{?scl_prefix}applicationinsights
Version: %{version}
Release: %{release}
Source0: applicationinsights-%{unmangled_version}.tar.gz
License: MIT
Group: Development/Libraries
BuildRoot: %{_tmppath}/applicationinsights-%{version}-%{release}-buildroot
Prefix: %{_prefix}
BuildArch: noarch
Vendor: Microsoft <aiengdisc@microsoft.com>
...
set -ex
%setup -n applicationinsights-%{unmangled_version} -n applicationinsights-%{unmangled_version}
%{?scl:EOF}
