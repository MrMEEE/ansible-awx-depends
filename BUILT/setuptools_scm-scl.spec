...
Name: %{?scl_prefix}setuptools_scm
Version: %{version}
Release: %{release}
Source0: setuptools_scm-%{unmangled_version}.tar.gz
License: MIT
Group: Development/Libraries
BuildRoot: %{_tmppath}/setuptools_scm-%{version}-%{release}-buildroot
Prefix: %{_prefix}
BuildArch: noarch
...
set -ex
%setup -n setuptools_scm-%{unmangled_version} -n setuptools_scm-%{unmangled_version}
%{?scl:EOF}
