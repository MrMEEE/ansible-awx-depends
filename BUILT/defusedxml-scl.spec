...
Version: %{version}
Release: %{release}
Source0: defusedxml-%{unmangled_version}.tar.gz
License: PSFL
Group: Development/Libraries
BuildRoot: %{_tmppath}/%{pkg_name}-%{version}-%{release}-buildroot
Prefix: %{_prefix}
BuildArch: noarch
Vendor: Christian Heimes <christian@python.org>
...
set -ex
%setup -n defusedxml-%{unmangled_version} -n defusedxml-%{unmangled_version}
%{?scl:EOF}
