...
Name: %{?scl_prefix}jmespath
Version: %{version}
Release: %{release}
Source0: jmespath-%{unmangled_version}.tar.gz
License: MIT
Group: Development/Libraries
BuildRoot: %{_tmppath}/jmespath-%{version}-%{release}-buildroot
Prefix: %{_prefix}
BuildArch: noarch
...
set -ex
%setup -n jmespath-%{unmangled_version} -n jmespath-%{unmangled_version}
%{?scl:EOF}
