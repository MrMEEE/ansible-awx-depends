...
Name: %{?scl_prefix}mistune
Version: %{version}
Release: %{release}
Source0: mistune-%{unmangled_version}.tar.gz
License: BSD
Group: Development/Libraries
BuildRoot: %{_tmppath}/mistune-%{version}-%{release}-buildroot
Prefix: %{_prefix}
BuildArch: noarch
...
set -ex
%setup -n mistune-%{unmangled_version} -n mistune-%{unmangled_version}
%{?scl:EOF}
