...
Version: %{version}
Release: %{release}
Source0: django-jsonfield-%{unmangled_version}.tar.gz
License: UNKNOWN
Group: Development/Libraries
BuildRoot: %{_tmppath}/%{pkg_name}-%{version}-%{release}-buildroot
Prefix: %{_prefix}
BuildArch: noarch
Vendor: Matthew Schinckel <matt@schinckel.net>
...
set -ex
%setup -n django-jsonfield-%{unmangled_version} -n django-jsonfield-%{unmangled_version}
%{?scl:EOF}
