...
%define unmangled_version 0.4.29
%define unmangled_version 0.4.29
%define release 1
...
Name: %{?scl_prefix}msrest
Version: %{version}
Release: %{release}
Source0: msrest-%{unmangled_version}.tar.gz
License: MIT License
Group: Development/Libraries
BuildRoot: %{_tmppath}/msrest-%{version}-%{release}-buildroot
Prefix: %{_prefix}
BuildArch: noarch
Vendor: Microsoft Corporation <UNKNOWN>
...
set -ex
%setup -n msrest-%{unmangled_version} -n msrest-%{unmangled_version}
%{?scl:EOF}
