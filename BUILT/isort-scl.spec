...
%define unmangled_version 4.3.4
%define unmangled_version 4.3.4
%define release 1
...
Name: %{?scl_prefix}isort
Version: %{version}
Release: %{release}
Source0: isort-%{unmangled_version}.tar.gz
License: MIT
Group: Development/Libraries
BuildRoot: %{_tmppath}/isort-%{version}-%{release}-buildroot
Prefix: %{_prefix}
BuildArch: noarch
Vendor: Timothy Crosley <timothy.crosley@gmail.com>
...
set -ex
%setup -n isort-%{unmangled_version} -n isort-%{unmangled_version}
%{?scl:EOF}
