...
Name: %{?scl_prefix}azure-common
Version: %{version}
Release: %{release}
Source0: azure-common-%{unmangled_version}.zip
License: MIT License
Group: Development/Libraries
BuildRoot: %{_tmppath}/azure-common-%{version}-%{release}-buildroot
Prefix: %{_prefix}
BuildArch: noarch
...
set -ex
%setup -n azure-common-%{unmangled_version} -n azure-common-%{unmangled_version}
%{?scl:EOF}
